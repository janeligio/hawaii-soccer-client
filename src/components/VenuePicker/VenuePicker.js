...
export default function VenuePicker(props) {
    ...
    return (
        <>
            <div className="abc">
                <input
                    className="form-input selected-venue-input"
                    type="text"
                    value={!!selectedVenue && selectedVenue.name}
                    readOnly
                />
                <button className="venuepicker-open" onClick={toggleModal}>
                    <FaEllipsisH color="white" />
                </button>
            </div>
            <div
                className="venuepicker-modal"
                style={{ display: `${open ? 'block' : 'none'}` }}
            >
                <div className="venuepicker-modal-content">
                    <div className="venues">
                        <button
                            className="venuepicker-close"
                            onClick={toggleModal}
                        >
                            Done
                        </button>
