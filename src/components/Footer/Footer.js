            ...
            <div className="footer-main">
                <section className="footer-section">
                    ...
                    <ul className="footer-section-list">
                        <li>
                            Interested in playing soccer but no one you know
                            does?
                        </li>
                ...
                <section className="footer-section">
                    ...
                    <ul className="footer-section-list">
                        ...
                        <li>
                            <FooterLink
                                link="https://github.com/janeligio/hawaii-soccer-client"
                                text="Client Code"
                            />
                        </li>
                        <li>
                            <FooterLink
                                link="https://github.com/janeligio/hawaii-soccer-server"
                                text="Server Code"
                            />
                        </li>
                    </ul>
